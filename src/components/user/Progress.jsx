...
function Progress() {
  ...
  const weightChange =
    latestProgress && firstData && firstData.weight
      ? (latestProgress.weight - firstData.weight).toFixed(1)
      : 0;
  const waistChange =
    latestProgress && firstData && firstData.waist
      ? (latestProgress.waist - firstData.waist).toFixed(1)
      : 0;
  const chestChange =
    latestProgress && firstData && firstData.chest
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-3xl shadow-xl p-6 border border-gray-100 hover:shadow-2xl transition-all duration-300">
            ...
            {weightChange !== 0 && (
              <div
                className={`flex items-center gap-2 text-sm font-semibold ${weightChange < 0 ? "text-green-600" : "text-red-600"}`}
              >
                {weightChange < 0 ? (
              ...
              <div className="flex items-end gap-1 h-16">
                {progressData
                  ...
                  .map((data, index) => {
                    ...
                    const height = data.weight
                      ? ((data.weight - minWeight) / (maxWeight - minWeight)) *
                        100
                      : 0;
                    return (
                      <div
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6 border border-gray-100 hover:shadow-2xl transition-all duration-300">
            ...
            {waistChange !== 0 && (
              <div
                className={`flex items-center gap-2 text-sm font-semibold ${waistChange < 0 ? "text-green-600" : "text-red-600"}`}
              >
                {waistChange < 0 ? (
                  <TrendingDown className="w-5 h-5" />
                ) : (
              ...
              <div className="flex items-end gap-1 h-16">
                {progressData
                  ...
                  .map((data, index) => {
                    ...
                    const height = data.waist
                      ? ((data.waist - minWaist) / (maxWaist - minWaist)) * 100
                      : 0;
                    return (
                      <div
                        key={index}
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6 border border-gray-100 hover:shadow-2xl transition-all duration-300">
            ...
            {chestChange !== 0 && (
              <div
                className={`flex items-center gap-2 text-sm font-semibold ${chestChange > 0 ? "text-green-600" : "text-red-600"}`}
              >
                {chestChange > 0 ? (
                  <TrendingUp className="w-5 h-5" />
                ) : (
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              ...
              <div className="flex items-end gap-1 h-16">
                {progressData
                  ...
                  .reverse()
                  .map((data, index) => {
                    const maxChest = Math.max(
                      ...progressData
                        .map((d) => d.chest || 0)
                        .filter((c) => c > 0),
                    );
                    const minChest = Math.min(
                      ...progressData
                        .map((d) => d.chest || 0)
                        .filter((c) => c > 0),
                    );
                    const height = data.chest
                      ? ((data.chest - minChest) / (maxChest - minChest)) * 100
                      : 0;
                    return (
                      <div
                        key={index}
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {progressData.map((entry, index) => {
                    const prevEntry =
                      index > 0 ? progressData[index - 1] : null;
                    const weightDiff =
                      prevEntry && entry.weight && prevEntry.weight
            ...
            <div className="space-y-3">
                ...
                <div className="bg-white rounded-xl p-4 flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-gray-800">
                      {Math.abs(weightChange)} kg perdidos
                    </div>
              ...
              {waistChange < 0 && (
                <div className="bg-white rounded-xl p-4 flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-gray-800">
                      {Math.abs(waistChange)} cm de cintura
                    </div>
                    <div className="text-sm text-gray-600">
                      Reducción constante
                    </div>
                ...
                <>
                  <div className="bg-white rounded-xl p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span
                        className={`text-2xl font-bold ${weightChange < 0 ? "text-green-600" : "text-red-600"}`}
                      >
                        {weightChange > 0 ? "+" : ""}
                        {weightChange} kg
                      </span>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${Math.min(Math.abs(weightChange) * 10, 100)}%`,
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span
                        className={`text-2xl font-bold ${waistChange < 0 ? "text-green-600" : "text-red-600"}`}
                      >
                        {waistChange > 0 ? "+" : ""}
                        {waistChange} cm
                      </span>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${Math.min(Math.abs(waistChange) * 5, 100)}%`,
                        }}
                      ></div>
                    </div>
                  </div>
        ...
        <ShareProgress
          progressData={{
            ...
            workoutsCompleted: progressData.reduce(
              (acc, p) => acc + (p.weeklyWorkouts || 0),
              0,
            ),
          }}
        />
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={newProgress.weight}
                    onChange={(e) =>
                      setNewProgress({ ...newProgress, weight: e.target.value })
                    }
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-purple-500 outline-none transition"
                    placeholder="72.5"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    value={newProgress.waist}
                    onChange={(e) =>
                      setNewProgress({ ...newProgress, waist: e.target.value })
                    }
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-purple-500 outline-none transition"
                    placeholder="81"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    value={newProgress.chest}
                    onChange={(e) =>
                      setNewProgress({ ...newProgress, chest: e.target.value })
                    }
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-purple-500 outline-none transition"
                    placeholder="98"
                  />
