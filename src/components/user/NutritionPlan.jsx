...
function NutritionPlan() {
  ...
  const nutritionPlan = {
    ...
    meals: [
      ...
      },
      {
        ...
        foods: [
          {
            name: "Pechuga de pollo grillada (150g)",
            calories: 250,
            protein: 45,
            carbs: 0,
            fats: 7,
          ...
          {
            name: "Ensalada verde con aceite de oliva",
            calories: 90,
            protein: 2,
            carbs: 8,
            fats: 7,
  ...
  const totalConsumed = completedMeals.reduce(
    (acc, mealId) => {
  ...
  const handleWizardComplete = async (formData) => {
    ...
    try {
      let response;
      if (formData.useAI) {
        console.log("Llamando a generateAIMealPlan con IA...");
        response = await generateAIMealPlan(formData);
      } else {
        console.log("Creando plan genérico...");
      ...
      setError(
        err.response?.data?.message || "Error al crear el plan nutricional",
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-green-50 p-6">
      {showWizard && (
        ...
        >
          ...
          >
            {loading && (
              <div className="absolute inset-0 bg-white/90 flex items-center justify-center rounded-3xl z-10 flex-col gap-3">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600">
                Alimentación balanceada para tus objetivos
              </p>
            </div>
            ...
            <div className="col-span-2 lg:col-span-1 bg-gradient-to-br from-red-50 to-pink-50 rounded-2xl p-6 border border-red-100">
              ...
              <div className="w-full bg-red-200 rounded-full h-2 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${getMacroPercentage(totalConsumed.calories, nutritionPlan.dailyCalories)}%`,
                  }}
                ></div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-100">
              ...
              <div className="w-full bg-purple-200 rounded-full h-2 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${getMacroPercentage(totalConsumed.protein, nutritionPlan.protein)}%`,
                  }}
                ></div>
              </div>
              <div className="text-xs text-gray-500 mt-1">
                Meta: {nutritionPlan.protein}g
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-2xl p-6 border border-yellow-100">
              ...
              <div className="w-full bg-yellow-200 rounded-full h-2 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${getMacroPercentage(totalConsumed.carbs, nutritionPlan.carbs)}%`,
                  }}
                ></div>
              </div>
              <div className="text-xs text-gray-500 mt-1">
                Meta: {nutritionPlan.carbs}g
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-6 border border-orange-100">
              ...
              <div className="w-full bg-orange-200 rounded-full h-2 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${getMacroPercentage(totalConsumed.fats, nutritionPlan.fats)}%`,
                  }}
                ></div>
              </div>
              <div className="text-xs text-gray-500 mt-1">
                Meta: {nutritionPlan.fats}g
              </div>
            </div>
        ...
        <div className="space-y-4">
          {nutritionPlan.meals.map((meal) => {
            ...
            return (
              ...
              >
                <div
                  className={`bg-gradient-to-r ${meal.gradient} p-6 relative overflow-hidden`}
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-200">
            ...
            <p className="text-blue-800 mb-4">
              Mantente hidratado es fundamental para el rendimiento y la
              recuperación.
            </p>
            <div className="grid grid-cols-4 gap-2">
              {[...Array(8)].map((_, i) => (
                <div
                  key={i}
                  className="aspect-square bg-gradient-to-br from-blue-400 to-cyan-400 rounded-lg flex items-center justify-center text-white text-xl"
                >
                  💧
                </div>
              ))}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex-1">
              ...
              <p className="text-green-100 mb-4">
                Este es un plan genérico. Responde algunas preguntas y te
                crearemos un plan adaptado a tus objetivos, preferencias y
                estilo de vida.
              </p>
