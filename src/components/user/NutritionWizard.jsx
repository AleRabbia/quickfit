...
function NutritionWizard({ onClose, onComplete }) {
  ...
  const goals = [
    ...
    },
    {
      ...
      label: "Manejo de Condición Médica",
      icon: "🏥",
  ...
  const activityLevels = [
    {
      id: "sedentary",
      label: "Sedentario",
      desc: "Oficina, poco movimiento",
      icon: "💺",
    },
    {
      id: "light",
      label: "Actividad Ligera",
      desc: "Movimiento ocasional",
      icon: "🚶",
    },
    {
      id: "moderate",
      label: "Actividad Moderada",
      desc: "Trabajo con movimiento",
      icon: "🏃",
    },
    {
      id: "heavy",
      label: "Actividad Intensa",
      desc: "Trabajo físico pesado",
      icon: "💪",
    },
  ];
  ...
  const supportTypes = [
    {
      id: "detailed_menu",
      label: "Menús Detallados",
      desc: "Día a día específico",
      icon: "📋",
    },
    {
      id: "flexible",
      label: "Intercambios Flexibles",
      desc: "Lista de opciones",
      icon: "🔄",
    },
    {
      id: "simple_recipes",
      label: "Recetas Sencillas",
      desc: "Rápidas y fáciles",
      icon: "⚡",
    },
  ];
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 3:
        return (
          formData.dietType &&
          Number(formData.mealsPerDay) >= 3 &&
          Number(formData.mealsPerDay) <= 6
        );
      case 4:
        return (
          ...
          formData.whoPreparesFood
        );
      case 5:
        return (
          formData.budget && formData.cookingTime && formData.preferredSupport
        );
      default:
        return false;
    }
  ...
  return (
    <div>
      {/*className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center overflow-y-auto z-50">*/}
        ...
        <div className="bg-gradient-to-r from-green-600 to-emerald-600 p-8 rounded-t-3xl text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-green-100">
              Responde estas preguntas para crear tu plan nutricional ideal
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {activityLevels.map((level) => (
                    <button
                      key={level.id}
                      onClick={() =>
                        handleInputChange("activityLevel", level.id)
                      }
                    ...
                    >
                      ...
                      <div
                        className={`text-sm ${formData.activityLevel === level.id ? "text-green-100" : "text-gray-600"}`}
                      >
                        {level.desc}
                      </div>
                    </button>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("goalDetails", e.target.value)
                  }
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-4">
                <p className="text-sm text-blue-800">
                  Esta información es confidencial y nos ayudará a crear un plan
                  seguro y adecuado para ti.
                </p>
              </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {digestiveIssuesOptions.map((issue) => (
                    <button
                      key={issue.id}
                      onClick={() =>
                        handleArrayToggle("digestiveIssues", issue.id)
                      }
                      className={`p-4 rounded-xl border-2 transition-all duration-300 ${
            ...
            <div className="space-y-6 animate-fadeIn">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {dietTypes.map((diet) => (
                    ...
                    >
                      ...
                      <div
                        className={`text-xs ${formData.dietType === diet.id ? "text-orange-100" : "text-gray-600"}`}
                      >
                        {diet.desc}
                      </div>
                    </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("firstMeal", e.target.value)
                    }
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-green-500 outline-none transition"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("lastMeal", e.target.value)
                    }
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-green-500 outline-none transition"
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("dislikedFoods", e.target.value)
                  }
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-green-500 outline-none transition resize-none"
                  rows="2"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("favoriteFoods", e.target.value)
                  }
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-green-500 outline-none transition resize-none"
                  rows="2"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("beverageConsumption", e.target.value)
                  }
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-green-500 outline-none transition resize-none"
                  rows="2"
            ...
            <div className="space-y-6 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {whoPreparesOptions.map((who) => (
                    <button
                      key={who.id}
                      onClick={() =>
                        handleInputChange("whoPreparesFood", who.id)
                      }
                      className={`p-5 rounded-xl border-2 transition-all duration-300 ${
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("eatsOutFrequency", e.target.value)
                  }
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-green-500 outline-none transition"
                  placeholder="Días por semana"
                />
              ...
              <div>
                <label className="flex items-center gap-3 cursor-pointer group p-4 border-2 border-gray-200 rounded-xl hover:border-green-300 transition">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("needPortable", e.target.checked)
                    }
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Incluiremos opciones fáciles de transportar
                    </p>
                  </div>
                </label>
              </div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  {supportTypes.map((support) => (
                    <button
                      key={support.id}
                      onClick={() =>
                        handleInputChange("preferredSupport", support.id)
                      }
                      className={`p-6 rounded-xl border-2 transition-all duration-300 text-left ${
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div
                            className={`text-sm ${formData.preferredSupport === support.id ? "text-green-100" : "text-gray-600"}`}
                          >
                            {support.desc}
                          </div>
                        </div>
